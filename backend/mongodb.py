...
def get_user(email):
    # TEMP: Always return a dummy user for testing
    if email == "1@gmail.com":
        return {
            ...
            "last_name": "User",
            "email": "1@gmail.com",
            # Valid hash for password '123' generated by werkzeug.security.generate_password_hash('123')
            "password": "pbkdf2:sha256:600000$w1Qw1Qw1$e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7e2e7"
        }
    return None
